...
, network, async, QuickCheck, vector, random, mtl
}:
...
cabal.mkDerivation (self: {
  ...
  testDepends = [ cabalInstall criterion hspec network async QuickCheck vector resourcet transformers transformersCompat liftedBase random mtl];
  meta = {
